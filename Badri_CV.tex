...
\begin{itemize}
    \item Modular forms and Ellipsoidal $T$-designs, The Ramanujan Journal, (recommended for publication)
    \item Inversion Formulas for the j-function Around Elliptic Points (Co-author: De Las Penas Castano A), in preparation
\end{itemize}
...
\begin{itemize}
%\item \emph{100 Years of Mock Theta Functions},\hfill May 18-19, 2020\\
...
\begin{itemize}
\item[] Sage(elementary), Python(elementary), Octave, LateX typsetting(Intermediate)\\
C, C++, html
\end{itemize}

\iffalse
\section{References}
\textbf{Prof. B. Sury} \hfill \textbf{Prof. Ramesh Sreekantan}\\
Professor \hfill Associate Professor\\
Stat-Math Unit \hfill Stat-Math Unit\\
Indian Statistical Institute\hfill Indian Statistical Institute\\
{sury@isibang.ac.in} \hfill {rsreekantan@isibang.ac.in}\\
\\
\iffalse
\textbf{Sidharthan Nair} \hfill \textbf{Dr. Sagar Kolte} \\
Assistant Vice-President \hfill Assistant Vice-President\\
FIC, Strats  \hfill Credit Suisse\\
Deutsche Bank, London  \hfill Mumbai, India\\
sidharthan.nair@db.com \hfill sagar.kolte@gmail.com\\
\fi
