...
\begin{itemize}
    \item Modular forms and Ellipsoidal $T$-designs, The Ramanujan Journal, (accepted)
    \item Inversion Formulas for the j-function Around Elliptic Points (Co-author: De Las Penas Castano A), submitted
    \item Hyperbolicity of the Plane Partition Jensen Polynomials (in preparation)
\end{itemize}
...
\begin{itemize}
\item \emph{Teaching Assistant for Research Experiences for Undergraduates at the University of Virginia}, \hfill Summer 2020-22
